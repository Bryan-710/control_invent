                    ...
                    <?php
                            ...
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas bi-box-seam fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                            .number_format($fila['total_categorias'],2).
                                            '</div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                            .number_format($fila['total_proveedores'],2).
                                            '</div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas bi-truck fa-2x text-gray-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <?php
                            $query = "SELECT
                                            ...
                                            SUM(inv.cantidad*inv.precio_unitario) AS total_categoria
                                            FROM inventario AS inv
                                            LEFT JOIN categorias AS cat ON(inv.id_categoria=cat.id_categoria)
                                            WHERE cat.nombre_categoria ='panaderia'
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Total de costo por categoria de panderia</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                            .number_format($fila['total_categoria'],2).
                                            '</div>
                                        </div>
                                        <div class="col-auto">
                        ...
                        ?>
                         ...
                         <?php
                            $query = "SELECT
                                            ...
                                            FROM inventario AS inv
                                            LEFT JOIN categorias AS cat ON(inv.id_categoria=cat.id_categoria)
                                            WHERE cat.nombre_categoria ='Conchon'
                                            GROUP BY cat.id_categoria;";
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Total de costo por categoria de Conchon</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                            .number_format($fila['total_categoria'],2).
                                            '</div>
                                        </div>
                        ...
                        <?php
                            $query = "SELECT
                                            ...
                                            FROM inventario AS inv
                                            LEFT JOIN categorias AS cat ON(inv.id_categoria=cat.id_categoria)
                                            WHERE cat.nombre_categoria ='Electrodomestico'
                                            GROUP BY cat.id_categoria;";
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                                Total de costo por categoria de Electrodomestico</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">'
                                            .number_format($fila['total_categoria'],2).
                                            '</div>
                                        </div>
                        ...
                        <div class="col-xl-8 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">Estadistica de Barras</h6>
...
<!-- --------------------------------------------------------------------------------------------------------------- -->
            ...
            <script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
            <script type="text/javascript" src="scrip_graficos/ColumnChart.js"></script>
