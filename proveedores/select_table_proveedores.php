<?php
            ...
            <tr>
                ...
                <td>
                    <a href="proveedores/update_proveedor.php?id=<?php echo $row['id_proveedor']; ?>" class="btn btn-warning"><i class="bi bi-pencil-square"></i></a>
                    <a href="proveedores/delete_proveedor.php?id=<?php echo $row['id_proveedor']; ?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                </td>
            </tr>
